...
results.to_csv(r"C:\Users\Winfried\Oemof\results\NewCapacity\TI8784O_dfmodel.csv")
...
f = open(r"C:\Users\Winfried\Oemof\results\meta\meta_TI8784O.txt","w")
...
pd.concat([
    pd.concat([df_node_BBEL_SEC, df_node_BBEL_FIN,df_node_BEEL_SEC, df_node_BEEL_FIN], axis=1)]).to_csv(r'C:\Users\Winfried\Oemof\results\TI8784O_EL.csv')
